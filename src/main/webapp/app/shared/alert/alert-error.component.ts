...
export class NpvrAlertErrorComponent implements OnDestroy {
    ...
    constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager) {
        ...
        this.cleanHttpErrorListener = eventManager.subscribe('npvrApp.httpError', (response) => {
            let i;
