...
import { NpvrHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { NpvrHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('NpvrHealthCheckComponent', () => {

        let comp: NpvrHealthCheckComponent;
        let fixture: ComponentFixture<NpvrHealthCheckComponent>;
        let service: NpvrHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [NpvrTestModule],
                declarations: [NpvrHealthCheckComponent],
                providers: [
                    NpvrHealthService
                ]
            })
            .overrideTemplate(NpvrHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(NpvrHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(NpvrHealthService);
        });
