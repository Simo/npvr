...
import { NpvrLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: NpvrLoginModalComponent;
        let fixture: ComponentFixture<NpvrLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [NpvrLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(NpvrLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(NpvrLoginModalComponent);
