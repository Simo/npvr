...
import it.insiel.siagri.npvr.config.audit.AuditEventConverter;
import it.insiel.siagri.npvr.domain.PersistentAuditEvent;
...
import static it.insiel.siagri.npvr.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
